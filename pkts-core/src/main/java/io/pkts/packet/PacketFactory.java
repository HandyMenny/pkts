...
public final class PacketFactory {
    ...
    private static final TransportPacketFactory transportFactory =
            new TransportPacketFactoryImpl(instance);
    ...
    /**
     * Obtain a reference to the {@link TransportPacketFactory} through which you can create any
     * arbitrary {@link Protocol#UDP} and {@link Protocol#TCP} packets.
     *
     * @return
     */
