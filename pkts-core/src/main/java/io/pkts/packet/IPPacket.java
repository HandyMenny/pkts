...
public interface IPPacket extends Packet, Cloneable {
    ...
    /**
     * This 16-bit field defines the entire packet (fragment) size, including header and data, in
     * bytes. The minimum-length packet is 20 bytes (20-byte header + 0 bytes data) and the maximum
     * is 65,535 bytes — the maximum value of a 16-bit word. The largest datagram that any host is
     ...
     *
     * <p>This field is an identification field and is primarily used for uniquely identifying
     * fragments of an original IP datagram. Some experimental work has suggested using the ID field
