...
public class PcapOutputStream extends OutputStream {
    ...
    /** The underlying {@link OutputStream} we will be using for writing the actual data. */
    private final OutputStream out;

    /**
     * The {@link PcapGlobalHeader} that tells us how to write out the various info to the stream
     * such as the byte order.
     */
    private final PcapGlobalHeader pcapHeader;

    public static PcapOutputStream create(
            final PcapGlobalHeader pcapHeader, final OutputStream out) {
        if (out == null) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Could not write the pcapheader to the stream due to IOException.", e);
        }
     ...
     *
     * @param frame the frame to write. If null is passed in, it will silently be ignored.
     */
     ...
     *
     * @param packet the packet to write. If null is passed in, it will silently be ignored.
     */
