...
/**
 * Signals that a {@link Protocol} was used in a context that was not allowed by the API.
 *
...
public final class IllegalProtocolException extends Exception {
    ...
    public IllegalProtocolException(
            final Protocol protocol, final String message, final Throwable cause) {
        super(message, cause);
        this.protocol = protocol;
    }

    /**
     * The {@link Protocol} that the user tried to use in the wrong text and as such this exception
     * was generated.
     *
     * @return
     */
