...
public interface PCapPacket extends Packet {
    ...
    /**
     * Get the actual length of what is contained in this frame. Note, if the captured length is
     * different from the total length then we have a fragmented packet
     *
